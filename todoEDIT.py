...
@author: jakej
"""
yes = open('todo_app_todo.txt','r+')
no = open('todo_app_finished.txt','r+')
yes2 = yes.read()
no2 = no.read()
todo = yes2.split('\n')
finish = no2.split('\n')
...
def todo_finished():
    ...
    while repeat == 6:
        ...
        for items in todo:
            ...
            print(count,')',items)
        print('')
        finished = input('please enter the task in which you finished: ')
        yes2.truncate(finished)
        no2.append(finished)
